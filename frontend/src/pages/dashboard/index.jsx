import { createPost, postComment, incrementPostLikes, deletePost, getAllPosts, getAllComments } from '@/config/redux/action/postAction';
              ...
              <div className={styles.scrollComponent}>
                ...
                <div className={styles.wrapper}>
                  ...
                  <div className={styles.createPostContainer}>
                      ...
                      {/* {console.log(`${BASE_URL}/uploads/${authState.user.userId.profilePicture}`)} */}
                  ...
                  <div className={styles.postsContainer}>
                      ...
                      {postState.postFetched && postState.posts.map((post) => {
                        return (
                          ...
                          <div key={post._id} className={styles.singleCard}>
                            ...
                            <div className={styles.singleCard__profileContainer}>
                                ...
                                <img className={styles.userProfile} src={`${BASE_URL}/uploads/${post.userId.profilePicture}`} alt=""/>
                                <div>
                    ...
                    <div onClick={(e) => {
                      e.stopPropagation();
                          ...
                          {postState.comments.length !== 0 &&
                            postState.comments.map((postComment) => {
                              return (
                                ...
                                >
                                  <img className={styles.commentProfile} src={`${BASE_URL}/uploads/${postComment.userId.profilePicture}`} alt="" />
                                  ...
                                  <div className={styles.singleComment__content}>
                                    ...
                                    <p className={styles.singleComment__body}>{postComment.body}</p>
                                  </div>
                                </div>
                              );
                            })}
                        ...
                        <div className={styles.postCommentContainer}>
                          ...
                          <input type = "" placeholder='Add a comment' value={commentText} onChange={(e) => setCommentText(e.target.value)} />
                          <div onClick={async () => {
