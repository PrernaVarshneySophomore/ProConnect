...
export default function ViewProfilePage({ userProfile }) {
    ...
    useEffect(() => {
      console.log("connections: ", authState.connections, userProfile.userId._id);

      

      if (authState.connections.find((user) => user.connectionId._id === userProfile.userId._id)) {
      ...
      if (authState.connectionRequests.find((user) => user.userId._id === userProfile.userId._id)) {
